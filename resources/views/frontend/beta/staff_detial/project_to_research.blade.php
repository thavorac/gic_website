        ...
        <div class="col-md-8 border-right">
            <div class="panel panel-default">
                ...
                <div class="title-detial">
                    <span><u>Projects to Research</u></span>
                </div>
                <div>
                    <span class="title-year">2013</span>
                    <span><a href="#"><br>P5: Privacy Preserving Perimeter Protection Project</a><br><a href="#">Maris</a>,
                        C.,<a href="#">Van Gyseghem, J.,</a><a href="#"> Colin, J.</a>,<a href="#"> Gayrel, C.</a>,<a href="#">Rath, T. M. A.</a>,
                        <a href="#"> Loute, A.</a>,<a href="#"> Dumortier, F.</a> &
                            <a href="#">Forget, C</a><br>1/08/13 => 1/08/16 </span>
                    <span class="title-year"><br>2010</span>
                    <span><a href="#"><br>iTec: innovative Technologies for an Engaging Classroom <br></a><a href="">Colin, J.</a><br>1/09/10 => 31/08/14</span>
                    <span class="title-year"><br>2009</span>
                    <span><a href="#"><br>Specification, verification et evaluation de performances de couches MAC, Reseau et Transport securisees pour des reseaux MANET </a><br>
                        <a href="#">Colin, J., Schumacher, L.</a> & <a href="#">Dynerowicz, S.</a><br>1/01/09 => 30/04/15</span>
                </div>
            </div>
            <div class="row">
                <div class="col-md-12">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="direct border" style="border-top: 4px solid #192f46">
                        ...
                        <div class="border-bottom">
                            <u>
                                <a href="{{ asset('staff_detial-project_to_research') }}">
                                    <span style="color:#205192">Project to Research</span>
                                    <img class="float-right" src="{{ asset('img/frontend/beta/homepage/brand-arrow-right.png') }}" />
                                </a>
                            </u>
                        </div>
                        ...
                        <div class="border-bottom">
                            <a href="{{ asset('staff_detial-activite.html') }}">
                                <span>Activite</span>
                                <img class="float-right" src="{{ asset('img/frontend/beta/homepage/brand-arrow-right.png') }}" />
                            </a>
                        </div>
