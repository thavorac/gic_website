...
@section ('title', trans('labels.backend.blog.title.main'))

@section('page-header')
    <h1>
        {{ trans('labels.backend.blog.title.main') }}
        <small>{{ trans('labels.backend.blog.title.index') }}</small>
    </h1>
            ...
            <div>
                <table class="table table-striped table-bordered table-hover dt-responsive nowrap" cellspacing="0" width="100%" id="data-table">
                    ...
                    <tr>
                        ...
                        <th>{{ trans('labels.backend.blog.fields.title') }}</th>
                        <th>{{ trans('labels.backend.blog.fields.content') }}</th>
                        <th>{{ trans('labels.backend.blog.fields.belong_to') }}</th>
                        <th>{{ trans('labels.backend.blog.fields.status') }}</th>
