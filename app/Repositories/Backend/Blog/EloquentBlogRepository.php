 ...
 */
class EloquentBlogRepository implements BlogRepositoryContract
{
    /**
     * @param  $id
     ...
     * @return mixed
     */
    public function getBlogsPaginated($per_page, $order_by = 'sort', $sort = 'asc')
    {
        return Blog::orderBy($order_by, $sort)
            ->paginate($per_page);
    }
     ...
     * @return mixed
     */
    public function getAllBlogs($order_by = 'sort', $sort = 'asc')
    {
        return Blog::orderBy($order_by, $sort)
            ->get();
    }
