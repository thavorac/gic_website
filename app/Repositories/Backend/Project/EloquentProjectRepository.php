...
class EloquentProjectRepository implements ProjectRepositoryContract
{
     ...
     * @return mixed
     */
    public function getProjectsPaginated($per_page, $order_by = 'sort', $sort = 'asc')
    {
        return Project::orderBy($order_by, $sort)
            ->paginate($per_page);
    }
     ...
     * @return mixed
     */
    public function getAllProjects($order_by = 'sort', $sort = 'asc')
    {
        return Project::orderBy($order_by, $sort)
            ->get();
    }
    ...
    {
        if (Project::where('name', $input['name'])->first()) {
