 ...
 */
class EloquentPartnerTypeRepository implements PartnerTypeRepositoryContract
{
    /**
     * @param  $id
    ...
    {
        if (! is_null(PartnerType::find($id))) {
     ...
     * @return mixed
     */
    public function getPartnerTypesPaginated($per_page, $order_by = 'sort', $sort = 'asc')
    {
        return PartnerType::orderBy($order_by, $sort)
            ->paginate($per_page);
    }
     ...
     * @return mixed
     */
    public function getAllPartnerTypes($order_by = 'sort', $sort = 'asc')
    {
        return PartnerType::orderBy($order_by, $sort)
            ->get();
    }
    ...
    {
        if (PartnerType::where('name', $input['name'])->first()) {
