...
class EloquentCourseRepository implements CourseRepositoryContract
{
     ...
     * @return mixed
     */
    public function getCoursesPaginated($per_page, $order_by = 'sort', $sort = 'asc')
    {
     ...
     * @return mixed
     */
    public function getAllCourses($order_by = 'sort', $sort = 'asc')
    {
        return Course::orderBy($order_by, $sort)
            ->get();
    }
    ...
    {
        if (Course::where('name', $input['name'])->first()) {
