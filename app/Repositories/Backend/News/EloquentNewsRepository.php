 ...
 */
class EloquentNewsRepository implements NewsRepositoryContract
{
    /**
     * @param  $id
     ...
     * @return mixed
     */
    public function getNewssPaginated($per_page, $order_by = 'sort', $sort = 'asc')
    {
        return News::orderBy($order_by, $sort)
            ->paginate($per_page);
    }
     ...
     * @return mixed
     */
    public function getAllNewss($order_by = 'sort', $sort = 'asc')
    {
        return News::orderBy($order_by, $sort)
            ->get();
    }
