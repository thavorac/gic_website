 ...
 */
class EloquentProgramRepository implements ProgramRepositoryContract
{
    /**
     * @param  $id
     ...
     * @return mixed
     */
    public function getProgramsPaginated($per_page, $order_by = 'sort', $sort = 'asc')
    {
        return Program::orderBy($order_by, $sort)
            ->paginate($per_page);
    }
     ...
     * @return mixed
     */
    public function getAllPrograms($order_by = 'sort', $sort = 'asc')
    {
        return Program::orderBy($order_by, $sort)
            ->get();
    }
    ...
    {
        if (Program::where('name', $input['name'])->first()) {
