...
//cowntdown function. Set the date by modifying the date in next line (January 01, 2013 00:00:00):
		var austDay = new Date("October 01, 2017 00:00:00");
...
//function for the contact-form dropdown
	function contact() {
		if ($("#cform").is(":hidden"))
		{
			$("#ribbon").css({"background":"url(../../../img/frontend/under_construction/ribbon.png) bottom left no-repeat"});
			$("#home").slideUp("fast");
			$("#cform").slideDown("slow");
		}
		else{
			$("#ribbon").css({"background":"url(../../../img/frontend/under_construction/ribbon.png) top left no-repeat"});
			$("#cform").slideUp("slow");
			$("#home").slideDown("slow");
		}
	}
